...
Java_com_wangheart_rtmpfile_ffmpeg_FFmpegHandle_setCallback(JNIEnv *env, jobject instance, jobject pushCallback1) {
    //转换为全局变量
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_wangheart_rtmpfile_ffmpeg_FFmpegHandle_pushRtmpFile(JNIEnv *env, jobject instance, jstring path_) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_wangheart_rtmpfile_ffmpeg_FFmpegHandle_initVideo(JNIEnv *env, jobject instance, jstring url_,jint jwidth,jint jheight) {
    ...
    //注册所有的编码器，解码器，h264,mpeg2,音频等结构体，协议等，封装格式的结构体，网络协议库等
    av_register_all();
    ...
    //编码器的ID，这里为264编码器，        /////////可以根据video_st里的codecID 参数赋值
...
//        av_dict_set(&param, "preset", "slow", 0);
    ...
    //分配输出流 ，在用户调用avformat_write_header()之前
